...
char nav[30]="Not Avaialable";	
	...
	printf("\t\t::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n");
	printf("\t\t::\t\t\t\t\t\t\t\t::\n");
	printf("\t\t:.\t ---- Welcome to Rajarata Student Registeration System Admin Panel----\t.:\n");
	printf("\t\t::\t\t\t V 1.0.0\t\t\t\t::\n");
	printf("\t\t::\t\t\t\t\t\t\t\t::\n");
	printf("\t\t::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n");
	printf("\t\t::\t\t\t\t\t\t\t\t::\n");
	...
	void check(FILE *s){
		if(s==NULL){
			printf("successfully closing File");
		}
	}
	...
	void addStudent(FILE *Fp){					
							...
							scanf("%d",&stud.id); 
							printf("\n");
							printf("Department of student [EET,MTT,BBT,FDT,ICT] : ");
			...
			//Department of Electrical and Electronic Technology 
					...
					while(3){
							...
							if(cnt==-1)
							  break;
							  	...
							  	if(elec==0){
							  		printf("\n=================================================================\n");
							  			printf("\t\tElectrical and Electronic Technology\n");
								printf("=================================================================\n");
				 ...
				 int mec=0;				
					...
					while(3){
							...
							if(cnt==-1)
							  break;
							  	if(strcmp(stud.department,"Department of ICT")==0){
							  	if(mec==0){
							  	printf("\n=================================================================\n");
							  	printf("\n\t\tDepartment\n");
								printf("=================================================================\n");
					 ...
					 // Department of Bio Process Technology
				 ...
				 int sof=0;		
					...
					while(3){
							...
							if(cnt==-1)
							  break;
							  	if(strcmp(stud.department,"Department of Bio Process Technology")==0){
							  	if(sof==0){
							  		printf("\n=================================================================\n");
							  			printf("\n\t\tDepartment\n");
								printf("=================================================================\n");
				 ...
				 int chem=0;		
					...
					while(3){
							...
							if(cnt==-1)
							  break;
							  	if(strcmp(stud.department,"Department of Food Technology")==0){
							  	if(chem==0){
							  		printf("\n=================================================================\n");
							  			printf("\n\t\tDepartment\n");
								printf("=================================================================\n");
					...
					// Department of Meterial Technology
				 ...
				 int chem=0;		
					...
					while(3){
							...
							if(cnt==-1)
							  break;
							  	if(strcmp(stud.department,"Department of Meterial Technology")==0){
							  	if(chem==0){
							  		printf("\n=================================================================\n");
							  			printf("\n\t\tDepartment\n");
								printf("=================================================================\n");
